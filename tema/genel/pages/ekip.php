                ...
                <div class="row">
                    ...
                    <div class="col-md-6 left-content">
                        <div class="vk-img-frame">
                            <img src="<?php echo tema;?>/uploads/ekibimiz/<?php echo $Sonuc['resim'];?>" alt="<?php echo $Sonuc['adi'];?>" />
                        </div>
                    </div>
                    <!--./left-->
                    ...
                    <div class="col-md-6 right-content">
                        <div class="content">
							...
							<div class="designation"><?php echo $Sonuc['gorev']; ?></div>
                            <?php echo $Sonuc['aciklama'];?>							
							<div class="sharethis-inline-share-buttons"></div>
							<a href="<?php echo $htc['ekiburl']; ?><?php echo $html;?>" class="vk-btn vk-btn-icon vk-btn-l vk-border-bottom vk-btn-default text-uppercase mt-2">
                                <span class="title"><?=@$dil['txt44'];?></span>
