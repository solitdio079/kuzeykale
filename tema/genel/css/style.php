...
.vk-list-icon li:after {
    ...
    background: -moz-linear-gradient(left, <?php echo renk3;?> 0%, #fff 100%);

    background: -webkit-linear-gradient(left, <?php echo renk3;?> 0%, #fff 100%);

    background: -webkit-gradient(linear, left top, right top, from(<?php echo renk3;?>), to(#fff));

    background: -o-linear-gradient(left, <?php echo renk3;?> 0%, #fff 100%);

    background: linear-gradient(to right, <?php echo renk3;?> 0%, #fff 100%);
...
.vk-menu-right li a:focus {
    ...
    background: -moz-linear-gradient(left, <?php echo renk3;?> 0%, #ffffff 100%);

    background: -webkit-linear-gradient(left, <?php echo renk3;?> 0%, #ffffff 100%);

    background: -webkit-gradient(linear, left top, right top, from(<?php echo renk3;?>), to(#ffffff));

    background: -o-linear-gradient(left, <?php echo renk3;?> 0%, #ffffff 100%);

    background: linear-gradient(to right, <?php echo renk3;?> 0%, #ffffff 100%);

    filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='<?php echo renk3;?>', endColorstr='#ffffff', GradientType=1);
...
.vk-btn-icon.vk-btn-default:focus {
    ...
    -webkit-box-shadow: inset 0px 0px 0px 2px <?php echo renk1;?>;

    -moz-box-shadow: inset 0px 0px 0px 2px <?php echo renk1;?>;

    box-shadow: inset 0px 0px 0px 2px <?php echo renk1;?>;
...
.vk-iconbox-border {
    ...
    border: 2px solid <?php echo renk2;?>;
...
.vk-tab.vk-tab-border .vk-nav-tabs li.active a {
    ...
    -webkit-box-shadow: inset 0 5px 0 <?php echo renk1;?>;

    -moz-box-shadow: inset 0 5px 0 <?php echo renk1;?>;

    box-shadow: inset 0 5px 0 <?php echo renk1;?>;
...
.vk-tab.vk-tab-background .vk-nav-tabs li a {
    ...
    border-top: solid 5px <?php echo renk1;?>;
...
.vk-tab.tab-vertical-outline .vk-nav-tabs li.active {
    ...
    border-left: solid 5px <?php echo renk1;?>;
...
.box-heading .first-letter {
    ...
    border: 8px solid <?php echo renk2;?>;
...
.box-tooltip .vk-tooltip-style-2 .tooltip-arrow {
    ...
    border-top-color: <?php echo renk2;?> !important;
...
.tooltip-arrow {
    ...
    border-top-color: <?php echo renk1;?> !important;
...
.shopping-cart-list {
    ...
    border-top: 3px solid <?php echo renk1;?>;
...
@media (min-width: 992px) {
    ...
    .vk-header-left-menu .shopping-cart-list {
        ...
        border-left: 1px solid <?php echo renk2;?>;

        border-right: 1px solid <?php echo renk2;?>;
...
@media screen and (min-width: 992px) {
    ...
    .who-we-are .left:before {
        ...
        border-right-color: <?php echo renk1;?>;
...
.t-our-service .home-builder-services-item .home-builder-img .imagebox .shadow {
    ...
    border-bottom-color: <?php echo renk1;?>;
...
.gallery-clearfix .vk-clear-padding .img .box {
    ...
    background-image: -webkit-linear-gradient(322deg, <?php echo renk1;?>8c, #e2bf579e);

    background-image: -o-linear-gradient(322deg, <?php echo renk1;?>8c, #e2bf579e);

    background-image: linear-gradient(128deg, <?php echo renk1;?>8c, #e2bf579e);
...
.vk-table-shopcart-style-5 input[type='radio']+label:before {
    ...
    border: 1px solid <?php echo renk2;?>;
...
.card-active {
    ...
    border-bottom: 10px solid <?php echo renk1;?>;
...
.projects-item-image cite {
    ...
    background-color: <?php echo renk1;?>40;
...
#accordion .show .card-body {
    ...
    border-left: solid 2px <?php echo renk1;?> !important;
...
.row .col-lg-6:nth-child(1) .single-services-box {
    ...
    border-right: 1px solid <?php echo renk1;?>;

    border-bottom: 1px solid <?php echo renk1;?>;
...
.row .col-lg-4:nth-child(3) .single-services-box {
    ...
    border-left: 1px solid <?php echo renk1;?>;
...
.row .col-lg-4:nth-child(7) .single-services-box {
    ...
    border-top: 1px solid <?php echo renk1;?>;
