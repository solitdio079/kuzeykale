...
var YTDataV3 = { /* singleton */
	...
	search: function(param, response) {
		...
		//param = {q: "234", start-index: "1", max-results: 30};
		//var q = 'something';

		var q = encodeURIComponent(param.q);

		var url = 'https://www.googleapis.com/youtube/v3/search?q='+q+'&key='+this.key+'&maxResults='+param['max-results']+'&order='+this.order+'&type=video&videoEmbeddable=true&part=snippet';
